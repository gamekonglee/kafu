...
import cc.bocang.bocang.utils.AppDate;
import cc.bocang.bocang.utils.AppLog;
import cc.bocang.bocang.utils.AppNumber;
...
public class JSONObject implements Serializable {
	...
	public String getString(String key) {
		...
		if (value == null) {
			...
			return StringUtil.decodeUnicode((String) value);
		} else {
			return StringUtil.decodeUnicode(value.toString());
		}
	}
